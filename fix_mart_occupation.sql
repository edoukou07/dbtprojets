-- Fix Mart Occupation Zones - Corriger le calcul d'attribution
-- Recalculer avec statut VALIDE pour demandes_attribution
...
occupation_data as (
    select
        ...
        count(case when l.statut != 'disponible' and dv.lot_id is null then 1 end) as lots_reserves,
