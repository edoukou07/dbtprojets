  ...
  create  table "sigeti_node_db"."dwh_dimensions"."dim_domaines_activites_conventions__dbt_tmp"
...
domaines_categorises as (
    select
        -- Clé surrogate
        md5(cast(coalesce(cast(domaine_activite as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as domaine_key,
