  ...
  create  table "sigeti_node_db"."dwh_dimensions"."dim_phases_impenses__dbt_tmp"
...
final as (
    select
        md5(cast(coalesce(cast(phase_id as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(etape_id as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(action_code as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as phase_impense_key,
