...
select 
    md5(cast(coalesce(cast(annee_mois as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(etape_actuelle as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as delai_approbation_key,
    *
from aggregated
