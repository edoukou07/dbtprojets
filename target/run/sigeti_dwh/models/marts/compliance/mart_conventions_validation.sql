  ...
  create  table "sigeti_node_db"."dwh_marts_compliance"."mart_conventions_validation__dbt_tmp"
...
select 
    md5(cast(coalesce(cast(annee_mois as TEXT), '_dbt_utils_surrogate_key_null_') || '-' || coalesce(cast(etape_actuelle as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as convention_validation_key,
    *
from aggregated
