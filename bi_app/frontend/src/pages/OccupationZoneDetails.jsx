      ...
      <section>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">Superficie Totale</span>
                <span className="text-sm font-bold text-gray-900">{formatSuperficie(zoneData.superficie_totale)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-lg h-12 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg"></div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">Superficie Attribuée</span>
                <span className="text-sm font-bold text-blue-900">{formatSuperficie(zoneData.superficie_attribuee)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-lg h-12 relative overflow-hidden">
                <div 
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg transition-all duration-500"
                  style={{ width: `${zoneData.pct_superficie_attribuee || 0}%` }}
                >
                  <div className="absolute inset-0 flex items-center justify-end pr-3">
                    <span className="text-white font-semibold text-sm">{formatPercent(zoneData.pct_superficie_attribuee)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-600">Superficie Disponible</span>
                <span className="text-sm font-bold text-green-900">{formatSuperficie(zoneData.superficie_disponible)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-lg h-12 relative overflow-hidden">
                <div 
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-green-500 to-green-600 rounded-lg transition-all duration-500"
                  style={{ width: `${zoneData.pct_superficie_disponible || 0}%` }}
                >
                  <div className="absolute inset-0 flex items-center justify-end pr-3">
                    <span className="text-white font-semibold text-sm">{formatPercent(zoneData.pct_superficie_disponible)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200">
              <div className="flex items-center justify-around text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600">Attribuée</span>
                </div>
                <div className="flex items-center gap-2">
